...
public class UtilGrafos {
    ...
    public static void imprimirMatriz(Comparable[][] matriz, Map<Comparable, Vertice> vertices, String titulo){
    ...
    public static <T> T cargarGrafo(String nomArchVert, String nomArchAdy, boolean ignoreHeader, Class t){
