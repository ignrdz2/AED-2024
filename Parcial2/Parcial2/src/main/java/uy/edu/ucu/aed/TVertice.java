...
public class TVertice<T> implements IVertice<T>, Comparable<TVertice<T>> {
    ...
    @Override
    public int compareTo(TVertice<T> other) {
        // Assuming that the comparison is based on the etiqueta field
        // and that etiqueta implements Comparable
        return this.getEtiqueta().compareTo(other.getEtiqueta());
    }
}
